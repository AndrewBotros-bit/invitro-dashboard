...
export async function fetchAllData() {
  ...
  const [mainRanges, expenseRows, headcountRows, allCareRevRows, allRxRevRows, fundTimelineRanges] = await Promise.all([
    batchGetSheetValues({
      ...
      //     later vehicles' LPs).
      //   - cols: BZ (previously R, when the layout was annual-only through
      //     2028). The Sept 2026 CFO update introduced a quarterly grid —
      //     FY 2021..2024 (cols D/F/H/J) then Q4 2025..Q4 2028 (cols
      //     L/N/P/R/T/V/X/Z/AB/AD/AF/AH/AJ). Over-fetch to BZ so future
      //     period extensions land without needing a code change.
      ranges: [
        "'P&L'!A1:ZZ",
        "'Cashflow'!A1:ZZ",
        "'IRR & Valuation'!A1:BZ250",
