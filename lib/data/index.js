import { batchGetSheetValues, getExpenseSheetValues, getHeadcountSheetValues, getRevenueDetailsSheetValues } from '@/lib/googleSheets';
...
export async function fetchAllData() {
  ...
  const [mainRanges, expenseRows, headcountRows, allCareRevRows, allRxRevRows] = await Promise.all([
    batchGetSheetValues({
