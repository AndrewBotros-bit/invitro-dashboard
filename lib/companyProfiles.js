...
while easing administrative burden on facilities.`,
  ...
  Osta: {
    tagline: 'Where Tech Meets Trade, Mastery Redefined.',
    sector: 'Staffing · Marketplace',
    foundedYear: 2025,
    stage: 'On hold',
    description:
`Östa merges advanced AI and AR with skilled craftsmanship to
revolutionize handyman, electrical, HVAC, and plumbing solutions.
With transparent pricing, precise diagnostics, and real-time AI
technician support, we bring modern technology to age-old home
maintenance challenges.

Status: On hold — no new investment is being made in Östa at this time.`,
    links: { website: null, deck: null },
  },
