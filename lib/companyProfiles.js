...
per month), and refill rate.`,
  ...
  AllCare: {
    tagline: 'Home healthcare services marketplace',
    sector: 'Healthcare · Services',
    foundedYear: 2022,
    stage: 'Seed',
    description:
`AllCare connects patients needing in-home healthcare services with
licensed providers (nursing, therapy, specialty visits) across a
geographic service area. Revenue comes from per-visit fees plus
membership subscriptions for high-frequency users.

[PLACEHOLDER — replace with the real business model description.]

Key drivers: Service Units (SUs delivered per period), ARPU per service
unit, and provider retention.`,
    links: { website: null, deck: null },
  },
