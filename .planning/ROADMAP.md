...
- [ ] 02-03-PLAN.md — Gap closure: implement optional metric warning generation in validate.js
- [ ] 02-04-PLAN.md — Gap closure: null-safe formatters in Dashboard.jsx (fmt/fmtShort/pct return '---' for null)
